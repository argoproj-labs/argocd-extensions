...
E2E_NAMESPACE=argocd-extentions-e2e
E2E_TIMEOUT=120
E2E_REGISTRY_NOAUTH="localhost:5001"
E2E_REGISTRY_AUTH="localhost:5001"
...
for tag in 1.0.0 1.0.1 1.0.2 2.0.0 2.0.1 2.1.0 latest; do
	build_image_if_not_exist "localhost:5001/test-image" "$tag"
done
